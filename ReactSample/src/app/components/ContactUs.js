        ...
        return (
            <Container>
                <section className="my-5">
                    ...
                    <p className="text-center w-responsive mx-auto pb-5">Please select your area of interest below. An Infosys representative will contact you shortly after receiving your request.For our contact details in a specific geography, please select the Infosys subsidiary.</p>
                    <Row>
